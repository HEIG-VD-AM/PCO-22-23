...
int cmain()
{
    ...
    const int NB_TOURS_A = 2;
    const int NB_TOURS_B = 3;

    // Points de contrôle des aiguillages
    const std::vector<int> POINTS_CONTROLE_AIGUILLAGE_A = {24, 15};
    const std::vector<int> POINTS_CONTROLE_AIGUILLAGE_B = {21, 11};
